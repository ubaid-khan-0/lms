...
class LeaveQuotaDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
       ...
       ->addColumn('action', function ($query) use ($tableName) {
            ...
            $actions = [
                [
                    'label'   => 'Edit',
                    'url'     => route('admin.leavequota.edit', $query->id),
                    'icon'    => 'fa fa-edit',
                    'extra'   => '',
                    'permission'    => 'edit_leavequota'  // Passing the permission name for 'Edit'
                ],
                [
                    'label'   => 'Delete',
                    'url'     => 'javascript:void(0)',
                    'icon'    => 'fa fa-trash',
                    'extra'   => "onclick=\"deleteLeaveQuota('id', '$query->id', '$tableName')\"",
                    'permission'    => 'delete_leavequota'
                ]
            ];
     ...
     */
    public function query(LeaveQuota $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('leavetype')->title('Leave Type'),
    ...
    {
        return 'LeaveQuota_' . date('YmdHis');
    }
}
